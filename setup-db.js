...
const setupDatabase = async () => {
  ...
  if (error) {
    // If RPC doesn't exist, tables might need to be created via Supabase dashboard
    console.log('⚠️  Note: Tables may need to be created via Supabase SQL Editor');
    console.log('   Copy the SQL from this file and run it in your Supabase dashboard.\n');
  } else {
